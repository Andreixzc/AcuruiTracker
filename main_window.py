...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.startButton.setGeometry(QtCore.QRect(50, 400, 161, 51))
        self.startButton.setObjectName("startButton")
        self.textArea = QtWidgets.QTextEdit(self.centralwidget)
        self.textArea.setGeometry(QtCore.QRect(220, 390, 400, 71))
        self.textArea.setObjectName("textArea")
        self.cameraFeed = QtWidgets.QLabel(self.centralwidget)
        self.cameraFeed.setGeometry(QtCore.QRect(50, 50, 640, 320))
