...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def update_competition(self, cpf, competition):
        ...
        final_time = self.getTimeDiff(self.start_time, datetime.datetime.strptime(current_time, "%H:%M:%S").time())
        ...
        if exists:
            ...
            print(f"Updated {competition} for {cpf} with {final_time}")  # Debug print
        else:
            # Insert new record
            query_insert = f"""
            ...
            print(f"Inserted {competition} for {cpf} with {final_time}")  # Debug print
